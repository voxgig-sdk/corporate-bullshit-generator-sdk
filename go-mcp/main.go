// Command CorporateBullshitGenerator-mcp is an MCP server exposing the CorporateBullshitGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CorporateBullshitGenerator_list  — list records of an entity
//	CorporateBullshitGenerator_load  — load a single record of an entity
//
