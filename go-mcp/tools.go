...
type Args struct {
	Entity string         `json:"entity" jsonschema:"generate_corporate_bullshit"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CorporateBullshitGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "corporate-bullshit-generator_list",
		Description: "List records from CorporateBullshitGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "corporate-bullshit-generator_load",
		Description: "Load a single record from CorporateBullshitGenerator. " +
...
func runOp(client *sdk.CorporateBullshitGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CorporateBullshitGeneratorSDK, name string) (sdk.CorporateBullshitGeneratorEntity, error) {
	switch strings.ToLower(name) {
	case "generate_corporate_bullshit":
		return client.GenerateCorporateBullshit(nil), nil
