...
require_relative 'CorporateBullshitGenerator_types'
...
class CorporateBullshitGeneratorSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = CorporateBullshitGeneratorHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = CorporateBullshitGeneratorHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, CorporateBullshitGeneratorFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    CorporateBullshitGeneratorUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = CorporateBullshitGeneratorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = CorporateBullshitGeneratorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = CorporateBullshitGeneratorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => CorporateBullshitGeneratorError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue CorporateBullshitGeneratorError => err
    ...
    if fetched.is_a?(Hash)
      status = CorporateBullshitGeneratorHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = CorporateBullshitGeneratorError.new(
        "graphql_error", "CorporateBullshitGeneratorSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = CorporateBullshitGeneratorSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
