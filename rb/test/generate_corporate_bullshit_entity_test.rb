...
class GenerateCorporateBullshitEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CORPORATE_BULLSHIT_GENERATOR_TEST_GENERATE_CORPORATE_BULLSHIT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def generate_corporate_bullshit_basic_setup(extra)
  ...
  entid_env_raw = ENV["CORPORATE_BULLSHIT_GENERATOR_TEST_GENERATE_CORPORATE_BULLSHIT_ENTID"]
