...
#      offline in seeded test mode (CorporateBullshitGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CorporateBullshitGenerator_sdk.rb")
  SDK_CLASS = "CorporateBullshitGeneratorSDK"
  ...
  SDK_BASE = "CorporateBullshitGenerator_sdk"
