...
(0, node_test_1.describe)('GenerateCorporateBullshitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CorporateBullshitGeneratorSDK({
    ...
    (0, node_test_1.test)('direct-load-generate_corporate_bullshit', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-generate_corporate_bullshit', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CORPORATE_BULLSHIT_GENERATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CorporateBullshitGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CORPORATE_BULLSHIT_GENERATOR_TEST_GENERATE_CORPORATE_BULLSHIT_ENTID'];
    ...
    const client = new __1.CorporateBullshitGeneratorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GenerateCorporateBullshitDirect.test.js.map