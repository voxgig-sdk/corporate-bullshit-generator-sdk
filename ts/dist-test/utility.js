...
function envOverride(m) {
    if ('TRUE' === process.env.CORPORATE_BULLSHIT_GENERATOR_TEST_LIVE ||
        'TRUE' === process.env.CORPORATE_BULLSHIT_GENERATOR_TEST_OVERRIDE) {
    ...
    m.CORPORATE_BULLSHIT_GENERATOR_TEST_EXPLAIN = process.env.CORPORATE_BULLSHIT_GENERATOR_TEST_EXPLAIN || m.CORPORATE_BULLSHIT_GENERATOR_TEST_EXPLAIN;
    return m;
}
