...
} from '../CorporateBullshitGeneratorSDK'
...
class GenerateCorporateBullshitEntity extends CorporateBullshitGeneratorEntityBase<GenerateCorporateBullshit> {
  ...
  make(this: GenerateCorporateBullshitEntity) {
    return new GenerateCorporateBullshitEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GenerateCorporateBullshitLoadMatch, ctrl?: Control): Promise<GenerateCorporateBullshitEntity> {
