...
const CorporateBullshitGeneratorError_1 = require("./CorporateBullshitGeneratorError");
...
class Context {
    ...
    error(code, msg) {
        return new CorporateBullshitGeneratorError_1.CorporateBullshitGeneratorError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
