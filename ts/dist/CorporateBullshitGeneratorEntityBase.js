...
exports.CorporateBullshitGeneratorEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends CorporateBullshitGeneratorEntityBase<Advice>`.
class CorporateBullshitGeneratorEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.CorporateBullshitGeneratorEntityBase = CorporateBullshitGeneratorEntityBase;
//# sourceMappingURL=CorporateBullshitGeneratorEntityBase.js.map