...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CORPORATEBULLSHITGENERATOR_TEST_LIVE ||
    'TRUE' === process.env.CORPORATEBULLSHITGENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.CORPORATEBULLSHITGENERATOR_TEST_EXPLAIN = process.env.CORPORATEBULLSHITGENERATOR_TEST_EXPLAIN || m.CORPORATEBULLSHITGENERATOR_TEST_EXPLAIN
