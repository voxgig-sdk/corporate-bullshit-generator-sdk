...
from corporatebullshitgenerator_sdk.corporatebullshitgenerator_types import (
...
class GenerateCorporateBullshitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerateCorporateBullshitEntity(self._client, opts)
    ...
    def data_get(self) -> GenerateCorporateBullshit:
    ...
    def match_get(self) -> GenerateCorporateBullshit:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GenerateCorporateBullshit:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GenerateCorporateBullshit().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
