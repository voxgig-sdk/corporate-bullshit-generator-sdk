...
from corporatebullshitgenerator_sdk.utility import register

# Load features
from corporatebullshitgenerator_sdk.feature.base_feature import CorporateBullshitGeneratorBaseFeature
from corporatebullshitgenerator_sdk.features import _has_feature, _make_feature
...
class CorporateBullshitGeneratorSDK:
    ...
    def get_utility(self):
        return CorporateBullshitGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CorporateBullshitGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GenerateCorporateBullshit(self, data=None) -> "GenerateCorporateBullshitEntity":
        ...
        from corporatebullshitgenerator_sdk.entity.generate_corporate_bullshit_entity import GenerateCorporateBullshitEntity
        return GenerateCorporateBullshitEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CorporateBullshitGeneratorSDK":
        if sdkopts is None:
            sdkopts = {}
