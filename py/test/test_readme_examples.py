# CorporateBullshitGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CorporateBullshitGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CorporateBullshitGeneratorSDK(...) and CorporateBullshitGeneratorSDK.test(...) become
#      CorporateBullshitGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "corporatebullshitgenerator_sdk"
_SDK_CLASS = "CorporateBullshitGeneratorSDK"
...
_ENTITIES = {
    "GenerateCorporateBullshit": "generate_corporate_bullshit",
}
