...
class CorporateBullshitGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CorporateBullshitGeneratorTestRunner.getenv("CORPORATEBULLSHITGENERATOR_TEST_LIVE")
        override = CorporateBullshitGeneratorTestRunner.getenv("CORPORATEBULLSHITGENERATOR_TEST_OVERRIDE")
        ...
        explain = CorporateBullshitGeneratorTestRunner.getenv("CORPORATEBULLSHITGENERATOR_TEST_EXPLAIN")
