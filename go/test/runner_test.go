...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("CORPORATEBULLSHITGENERATOR_TEST_LIVE") == "TRUE" ||
		os.Getenv("CORPORATEBULLSHITGENERATOR_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("CORPORATEBULLSHITGENERATOR_TEST_EXPLAIN"); explain != "" {
