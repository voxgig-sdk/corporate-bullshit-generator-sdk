...
func registerSDKWords(r *eng.Registry, client *sdk.CorporateBullshitGeneratorSDK) {
...
func runOp(client *sdk.CorporateBullshitGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
