...
AQL-driven command-line client **and** interactive REPL for the CorporateBullshitGenerator
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `generate_corporate_bullshit`).
