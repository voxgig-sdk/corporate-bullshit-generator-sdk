...
AQL-driven CLI and REPL for the CorporateBullshitGenerator SDK. Positional arguments are
...
```sh
go build -o corporate-bullshit-generator-cli ./...
```
...
./corporate-bullshit-generator-cli list generate_corporate_bullshit
./corporate-bullshit-generator-cli load 1 generate_corporate_bullshit
./corporate-bullshit-generator-cli load '{id:1}' generate_corporate_bullshit
