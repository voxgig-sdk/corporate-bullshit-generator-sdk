...
class CorporateBullshitGeneratorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = CorporateBullshitGeneratorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = CorporateBullshitGeneratorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!CorporateBullshitGeneratorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, CorporateBullshitGeneratorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return CorporateBullshitGeneratorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = CorporateBullshitGeneratorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = CorporateBullshitGeneratorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = CorporateBullshitGeneratorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new CorporateBullshitGeneratorError($op . "_allow",
                "CorporateBullshitGeneratorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = CorporateBullshitGeneratorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new CorporateBullshitGeneratorError("graphql_error",
                "CorporateBullshitGeneratorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GenerateCorporateBullshit($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_generate_corporate_bullshit === null) {
                $this->_generate_corporate_bullshit = new GenerateCorporateBullshitEntity($this, null);
            }
            return $this->_generate_corporate_bullshit;
        }
        return new GenerateCorporateBullshitEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new CorporateBullshitGeneratorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
