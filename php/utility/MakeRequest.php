...
// CorporateBullshitGenerator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CorporateBullshitGeneratorMakeRequest
{
    public static function call(CorporateBullshitGeneratorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CorporateBullshitGeneratorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CorporateBullshitGeneratorResponse($fetched);
        } else {
