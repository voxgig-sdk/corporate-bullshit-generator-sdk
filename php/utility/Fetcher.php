...
// CorporateBullshitGenerator SDK utility: fetcher

class CorporateBullshitGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CorporateBullshitGeneratorSDK/1.0)';
    ...
    public static function call(CorporateBullshitGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {
