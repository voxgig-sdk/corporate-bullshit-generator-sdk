...
// CorporateBullshitGenerator SDK pipeline test
//
...
require_once __DIR__ . '/../corporatebullshitgenerator_sdk.php';
...
{
    private static function utility(): CorporateBullshitGeneratorUtility
    {
        return new CorporateBullshitGeneratorUtility();
    }
    ...
    private static function ctx(array $over = []): CorporateBullshitGeneratorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CorporateBullshitGeneratorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CorporateBullshitGeneratorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CorporateBullshitGeneratorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CorporateBullshitGeneratorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CorporateBullshitGeneratorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CorporateBullshitGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CorporateBullshitGeneratorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CorporateBullshitGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CorporateBullshitGeneratorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CorporateBullshitGeneratorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CorporateBullshitGeneratorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CorporateBullshitGeneratorResponse([]),
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        [, $err] = CorporateBullshitGeneratorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CorporateBullshitGeneratorSpec([]),
            'response' => null,
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        [, $err] = CorporateBullshitGeneratorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's']),
            'response' => new CorporateBullshitGeneratorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        [, $err] = CorporateBullshitGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's']),
            'response' => new CorporateBullshitGeneratorResponse(self::resp(200, ['v' => 1])),
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        [, $err] = CorporateBullshitGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's']),
            'response' => new CorporateBullshitGeneratorResponse(self::resp(200, ['v' => 2])),
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CorporateBullshitGeneratorMakeResponse::call($ctx);
    ...
    {
        $preset = new CorporateBullshitGeneratorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CorporateBullshitGeneratorSpec([]),
            'response' => new CorporateBullshitGeneratorResponse([]),
            'result' => new CorporateBullshitGeneratorResult([]),
        ...
        [$got, $err] = CorporateBullshitGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CorporateBullshitGeneratorResult([])]);
        [, $err] = CorporateBullshitGeneratorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CorporateBullshitGeneratorSpec([]), 'result' => null]);
        [, $err] = CorporateBullshitGeneratorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's']),
            'result' => new CorporateBullshitGeneratorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CorporateBullshitGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CorporateBullshitGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's']),
            'result' => new CorporateBullshitGeneratorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CorporateBullshitGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CorporateBullshitGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CorporateBullshitGeneratorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CorporateBullshitGeneratorSpec([]),
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CorporateBullshitGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CorporateBullshitGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CorporateBullshitGeneratorError('boom', 'boom');
        $utility->fetcher = function (CorporateBullshitGeneratorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CorporateBullshitGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CorporateBullshitGeneratorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CorporateBullshitGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CorporateBullshitGeneratorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CorporateBullshitGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CorporateBullshitGeneratorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CorporateBullshitGeneratorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CorporateBullshitGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CorporateBullshitGeneratorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CorporateBullshitGeneratorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CorporateBullshitGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CorporateBullshitGeneratorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CorporateBullshitGeneratorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CorporateBullshitGeneratorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CorporateBullshitGeneratorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CorporateBullshitGeneratorResult(['ok' => false])]);
        $this->expectException(CorporateBullshitGeneratorError::class);
        CorporateBullshitGeneratorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CorporateBullshitGeneratorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CorporateBullshitGeneratorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CorporateBullshitGeneratorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CorporateBullshitGeneratorBaseFeature();
        $b = new CorporateBullshitGeneratorBaseFeature();
        CorporateBullshitGeneratorFeatureAdd::call($ctx, $a);
        CorporateBullshitGeneratorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CorporateBullshitGeneratorBaseFeature
    {
        $f = new CorporateBullshitGeneratorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CorporateBullshitGeneratorFeatureAdd::call($ctx, self::named_feature('a'));
        CorporateBullshitGeneratorFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CorporateBullshitGeneratorFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CorporateBullshitGeneratorFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CorporateBullshitGeneratorFeatureAdd::call($ctx, $replace);
        ...
        CorporateBullshitGeneratorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CorporateBullshitGeneratorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CorporateBullshitGeneratorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CorporateBullshitGeneratorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CorporateBullshitGeneratorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CorporateBullshitGeneratorResponse(['headers' => null]),
            'result' => new CorporateBullshitGeneratorResult([]),
        ]);
        CorporateBullshitGeneratorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CorporateBullshitGeneratorResultBody::call($ctx);
