...
// CorporateBullshitGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CorporateBullshitGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'CorporateBullshitGeneratorSDK';
    ...
    private const SDK_BASE = 'corporatebullshitgenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../corporatebullshitgenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
