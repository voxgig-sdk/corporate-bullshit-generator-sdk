...
// CorporateBullshitGenerator SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CorporateBullshitGeneratorOmni::makeStructRunner(
    ...
    {
        return CorporateBullshitGeneratorOmni::objmodel(CorporateBullshitGeneratorOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return CorporateBullshitGeneratorOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return CorporateBullshitGeneratorOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CorporateBullshitGeneratorOmni::structfix($now, Struct::undef()))
                        !== json_encode(CorporateBullshitGeneratorOmni::structfix($val, Struct::undef()))) {
