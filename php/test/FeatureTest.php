...
// CorporateBullshitGenerator SDK feature test
//
...
class FtCtrl extends CorporateBullshitGeneratorControl
{
...
class FtClient
{
    ...
    private CorporateBullshitGeneratorUtility $utility;

    public function __construct(CorporateBullshitGeneratorUtility $utility, array $options)
    {
    ...
    public function get_utility(): CorporateBullshitGeneratorUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (CorporateBullshitGeneratorContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public CorporateBullshitGeneratorContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (CorporateBullshitGeneratorContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = CorporateBullshitGeneratorConfig::make_feature($name);
    ...
    private static function buildUrl(CorporateBullshitGeneratorSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof CorporateBullshitGeneratorError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new CorporateBullshitGeneratorResponse($fetched);
        }
    ...
    private function fail(CorporateBullshitGeneratorContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (CorporateBullshitGeneratorContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
