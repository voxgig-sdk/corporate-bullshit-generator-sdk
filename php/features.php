...
class CorporateBullshitGeneratorFeatures
{
    public static function make_feature(string $name)
    {
        switch ($name) {
            ...
            case "ratelimit":
                return new CorporateBullshitGeneratorRatelimitFeature();
            case "retry":
                return new CorporateBullshitGeneratorRetryFeature();
            case "test":
                return new CorporateBullshitGeneratorTestFeature();
            case "timeout":
                return new CorporateBullshitGeneratorTimeoutFeature();
            default:
                return new CorporateBullshitGeneratorBaseFeature();
        }
    }
