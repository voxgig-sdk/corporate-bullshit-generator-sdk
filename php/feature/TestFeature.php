...
// CorporateBullshitGenerator SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CorporateBullshitGeneratorTestFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    public function init(CorporateBullshitGeneratorContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CorporateBullshitGeneratorContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CorporateBullshitGeneratorParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CorporateBullshitGeneratorContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CorporateBullshitGeneratorContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = CorporateBullshitGeneratorParam::call($ctx, $k);
