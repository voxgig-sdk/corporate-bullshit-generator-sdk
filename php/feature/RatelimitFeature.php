...
// CorporateBullshitGenerator SDK ratelimit feature
...
class CorporateBullshitGeneratorRatelimitFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _acquire(CorporateBullshitGeneratorContext $ctx): void
    {
    ...
    private function _track(CorporateBullshitGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
