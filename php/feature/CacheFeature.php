...
// CorporateBullshitGenerator SDK cache feature
...
class CorporateBullshitGeneratorCacheFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _through(CorporateBullshitGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
