...
// CorporateBullshitGenerator SDK netsim feature
...
class CorporateBullshitGeneratorNetsimFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _simulate(CorporateBullshitGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CorporateBullshitGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
