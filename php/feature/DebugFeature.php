...
// CorporateBullshitGenerator SDK debug feature
...
class CorporateBullshitGeneratorDebugFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _finish(CorporateBullshitGeneratorContext $ctx, bool $ok): void
    {
