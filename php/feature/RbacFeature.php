...
// CorporateBullshitGenerator SDK rbac feature
...
class CorporateBullshitGeneratorRbacFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _required(CorporateBullshitGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(CorporateBullshitGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(CorporateBullshitGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
