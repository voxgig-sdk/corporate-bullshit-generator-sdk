...
|---|---|---|
| `ts/` | @voxgig-sdk/corporate-bullshit-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/corporate-bullshit-generator-sdk \
      --repository voxgig-sdk/corporate-bullshit-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/corporate-bullshit-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/corporate-bullshit-generator-sdk --id=<id>` removes it.
