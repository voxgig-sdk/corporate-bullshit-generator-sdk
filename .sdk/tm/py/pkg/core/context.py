...
from projectname_sdk.core.control import CorporateBullshitGeneratorControl
...
class CorporateBullshitGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CorporateBullshitGeneratorControl()
        ...
        if isinstance(sp, CorporateBullshitGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CorporateBullshitGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CorporateBullshitGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CorporateBullshitGeneratorOperation({})
    ...
    def make_error(self, code, msg):
        return CorporateBullshitGeneratorError(code, msg, self)
