...
from projectname_sdk import CorporateBullshitGeneratorSDK
from projectname_sdk.core.spec import CorporateBullshitGeneratorSpec
from projectname_sdk.core.result import CorporateBullshitGeneratorResult
from projectname_sdk.core.response import CorporateBullshitGeneratorResponse
from projectname_sdk.core.operation import CorporateBullshitGeneratorOperation
from projectname_sdk.core.error import CorporateBullshitGeneratorError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CorporateBullshitGeneratorBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CorporateBullshitGeneratorError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except CorporateBullshitGeneratorError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = CorporateBullshitGeneratorResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = CorporateBullshitGeneratorSDK.test(None, None)
        ...
        class TestInitFeature(CorporateBullshitGeneratorBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CorporateBullshitGeneratorBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = CorporateBullshitGeneratorSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = CorporateBullshitGeneratorSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CorporateBullshitGeneratorSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CorporateBullshitGeneratorSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CorporateBullshitGeneratorSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = CorporateBullshitGeneratorOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CorporateBullshitGeneratorSDK.test(None, setup_opts)
