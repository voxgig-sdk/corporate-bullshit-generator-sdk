# CorporateBullshitGenerator SDK feature corpus test
#
...
def _client(kase):
    ...
    CorporateBullshitGeneratorSDK(...), not CorporateBullshitGeneratorSDK.test(...): the `test` feature is
    ...
    return CorporateBullshitGeneratorSDK(opts)
