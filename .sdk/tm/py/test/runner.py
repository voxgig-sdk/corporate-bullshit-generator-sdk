...
class CorporateBullshitGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CorporateBullshitGeneratorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CorporateBullshitGeneratorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CorporateBullshitGeneratorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
...
def live_client_options():
    return CorporateBullshitGeneratorTestRunner.live_client_options()
