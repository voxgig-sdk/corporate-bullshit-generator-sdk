...
class CorporateBullshitGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CorporateBullshitGeneratorTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CorporateBullshitGeneratorTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CorporateBullshitGeneratorTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
