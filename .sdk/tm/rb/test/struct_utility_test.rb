...
class StructUtilityTest < Minitest::Test
  def setup
    ...
    @runner       = CorporateBullshitGeneratorOmni.make_runner(STRUCT_TEST_JSON_FILE, @client)
  ...
  def test_minor_stringify
    @runsetflags.call(@minor_spec["stringify"], {}, lambda { |vin|
      value = vin.key?("val") ? (vin["val"] == CorporateBullshitGeneratorOmni::NULLMARK ? "null" : vin["val"]) : ""
