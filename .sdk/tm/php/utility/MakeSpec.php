...
// CorporateBullshitGenerator SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class CorporateBullshitGeneratorMakeSpec
{
    public static function call(CorporateBullshitGeneratorContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = CorporateBullshitGeneratorGraphql::CONTENT_TYPE;
        } else {
