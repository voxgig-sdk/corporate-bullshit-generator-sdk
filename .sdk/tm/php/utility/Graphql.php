...
// CorporateBullshitGenerator SDK utility: graphql
//
...
class CorporateBullshitGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(CorporateBullshitGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(CorporateBullshitGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
