...
// CorporateBullshitGenerator SDK proxy feature
...
class CorporateBullshitGeneratorProxyFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    public function init(CorporateBullshitGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CorporateBullshitGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
