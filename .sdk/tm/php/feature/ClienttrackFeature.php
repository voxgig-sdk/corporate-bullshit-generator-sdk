...
// CorporateBullshitGenerator SDK clienttrack feature
...
class CorporateBullshitGeneratorClienttrackFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    public function PostConstruct(CorporateBullshitGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CorporateBullshitGenerator-SDK';
