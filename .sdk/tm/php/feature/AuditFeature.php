...
// CorporateBullshitGenerator SDK audit feature
...
class CorporateBullshitGeneratorAuditFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _emit(CorporateBullshitGeneratorContext $ctx, string $outcome): void
    {
