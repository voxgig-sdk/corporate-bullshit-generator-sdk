...
// CorporateBullshitGenerator SDK timeout feature
...
class CorporateBullshitGeneratorTimeoutFeature extends CorporateBullshitGeneratorBaseFeature
{
    ...
    private function _with_timeout(CorporateBullshitGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CorporateBullshitGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
