...
// CorporateBullshitGenerator SDK utility type

class CorporateBullshitGeneratorUtility
{
    ...
    public static function copy(CorporateBullshitGeneratorUtility $src): CorporateBullshitGeneratorUtility
    {
        $u = new CorporateBullshitGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
