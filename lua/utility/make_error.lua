...
local function make_error_util(ctx, err)
  ...
  local msg = "CorporateBullshitGeneratorSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CorporateBullshitGeneratorError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == CorporateBullshitGeneratorError then
