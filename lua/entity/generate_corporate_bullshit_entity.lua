...
local GenerateCorporateBullshitEntity = {}
GenerateCorporateBullshitEntity.__index = GenerateCorporateBullshitEntity


function GenerateCorporateBullshitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenerateCorporateBullshitEntity)
  self._name = "generate_corporate_bullshit"
  self._client = client
...
function GenerateCorporateBullshitEntity:get_name()
  return self._name
end


function GenerateCorporateBullshitEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenerateCorporateBullshitEntity.new(self._client, opts)
end
...
function GenerateCorporateBullshitEntity:mark_deleted()
  self._deleted = true
end


function GenerateCorporateBullshitEntity:deleted()
  return true == self._deleted
end


function GenerateCorporateBullshitEntity:data_set(args)
  if args ~= nil then
...
function GenerateCorporateBullshitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenerateCorporateBullshitEntity:match_set(args)
  if args ~= nil then
...
function GenerateCorporateBullshitEntity:match_get()
...
function GenerateCorporateBullshitEntity:stream(action, args, callopts)
...
---@param reqmatch GenerateCorporateBullshitLoadMatch
---@param ctrl? table
---@return GenerateCorporateBullshit
---@return string? err
function GenerateCorporateBullshitEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GenerateCorporateBullshitEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GenerateCorporateBullshitEntity
