...
describe("GenerateCorporateBullshitDirect", function()
  it("should direct-load-generate_corporate_bullshit", function()
    local setup = generate_corporate_bullshit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-generate_corporate_bullshit", setup.live and "live" or "unit")
