...
function runner.env_override(m)
  local live = runner.getenv("CORPORATE_BULLSHIT_GENERATOR_TEST_LIVE")
  local override = runner.getenv("CORPORATE_BULLSHIT_GENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CORPORATE_BULLSHIT_GENERATOR_TEST_EXPLAIN")
