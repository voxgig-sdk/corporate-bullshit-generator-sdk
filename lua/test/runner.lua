...
function runner.env_override(m)
  local live = runner.getenv("CORPORATEBULLSHITGENERATOR_TEST_LIVE")
  local override = runner.getenv("CORPORATEBULLSHITGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CORPORATEBULLSHITGENERATOR_TEST_EXPLAIN")
